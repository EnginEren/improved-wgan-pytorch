...
# MODE = 'wgan-gp'
NDF = 5 # Model dimensionality (critic)
...
KAPPA = 0.1 # How to scale generator's ACGAN loss relative to WGAN loss
...
LR_c = 5e-6
LR_reg = 5e-6
optimizer_g = torch.optim.Adam(aG.parameters(), lr=LR_g, betas=(0,0.9))
optimizer_d = torch.optim.Adam(aD.parameters(), lr=LR_c, betas=(0,0.9))
